...
- [x] Phase 8: Ability progression + gating — Double Jump, three gate types, dramatic fanfare
  ...
  - VerticalSliceBootstrap.cs — BuildAbilityGate/BuildHiddenPlatform/BuildAbilityPickup/BuildLorePickup helpers; Room 1: spectral Air Dash gate at col 14 + hidden platform cols 20-22 row 10 + Double Jump orb; Room 2: cracked wall Double Jump gate at col 13 row 3 + secret ledge cols 14-17 row 3 + LorePickupTrigger; LorePickupTrigger inner class (ItemPickedUpEvent "lore_shadow_king")
  - web-prototype/public/vertical-slice-demo.html — doubleJumpUnlocked/P_djUsed/gates[]/abilityOrbs[]/lorePickups[]; double jump Z×2; gate AABB collision + dissolve; orb bob + pickup; dramatic fanfare freeze (Time_frozen) + bars + text; initRoom1Gates()/initRoom2Gates(); hidden platform + secret ledge grid tiles
